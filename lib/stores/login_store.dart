import 'package:charusat_blood_donor/pages/registration_page.dart';
...
import 'package:charusat_blood_donor/pages/otp_page.dart';
...
//    dynamic resp = await callable.call({'phone':_phoneNumber});
//    if (resp.data) {
//      // user exists
//    }
